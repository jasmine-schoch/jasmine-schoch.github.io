  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/logo-black.png" alt="Logo featuring a Jasmine flower and bamboo" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.instagram.com/jasmine.schoch/"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/jasmine-schoch/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with ❤ by Jas</p>
      </div>
    </footer>
  );
}
